...
<html>
	<head>
		<title>Areto Systems Signup error</title>
		<meta charset="UTF-8">
	...
	<section id="features">
			<div class="our-service-inner">
				<div class="container">
					...
					<h4 class="text-center main-title" style="color:red;">We're sorry, for some reason you have been identified as a robot</h4>
					<p class="text-center sub-title">Kindly contact sales directly on sales@aretosystems.com or try again</p>
